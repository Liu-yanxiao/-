...
IMPLEMENT_DYNAMIC(Manager_Dlg, CDialogEx)

Manager_Dlg::Manager_Dlg(CWnd* pParent /*=nullptr*/)
...
Manager_Dlg::~Manager_Dlg()
{
}

void Manager_Dlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(Manager_Dlg, CDialogEx)
	ON_BN_CLICKED(IDC_BUTTON1, &Manager_Dlg::OnBnClickedButton1)
	ON_BN_CLICKED(IDC_BUTTON2, &Manager_Dlg::OnBnClickedButton2)
END_MESSAGE_MAP()
...
void Manager_Dlg::OnBnClickedButton1()
{
	// TODO: 在此添加控件通知处理程序代码

	Manager_Change_Dlg dlg;
	dlg.DoModal();
	EndDialog(0);
...
void Manager_Dlg::OnBnClickedButton2()
{
	// TODO: 在此添加控件通知处理程序代码
